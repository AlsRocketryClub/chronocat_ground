...
TELEMETRY_PACKET_SIZE_V1 = 129
TELEMETRY_PACKET_SIZE_V2 = 163
TELEMETRY_PACKET_SIZE_V3 = 165
TELEMETRY_PACKET_SIZE = TELEMETRY_PACKET_SIZE_V3
PID_TELEMETRY_HEATER_COUNT = 12
PID_TELEMETRY_RECORD_SIZE = 35
PID_TELEMETRY_PACKET_SIZE = 442
COMBINED_TELEMETRY_PACKET_SIZE = 587
TELEMETRY_TEMP_COUNT = 12
...
COMMAND_NAMES = {
    ...
    COMMAND_SYSTEM_RESET: "system reset",
}
